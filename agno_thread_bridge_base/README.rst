...
.. |badge3| image:: https://img.shields.io/badge/github-Escodoo%2Fai--addons-lightgray.png?logo=github
    :target: https://github.com/Escodoo/ai-addons/tree/18.0/agno_thread_bridge_base
...
``agno_thread_bridge_base.bridge_auth_token`` (wins over ``odoo.conf``).
Shared by child modules (``agno_thread_bridge_crm``,
...
`feedback <https://github.com/Escodoo/ai-addons/issues/new?body=module:%20agno_thread_bridge_base%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `Escodoo/ai-addons <https://github.com/Escodoo/ai-addons/tree/18.0/agno_thread_bridge_base>`_ project on GitHub.
