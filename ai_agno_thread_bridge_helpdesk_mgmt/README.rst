...
.. |badge3| image:: https://img.shields.io/badge/github-Escodoo%2Fai--addons-lightgray.png?logo=github
    :target: https://github.com/Escodoo/ai-addons/tree/18.0/ai_agno_thread_bridge_helpdesk_mgmt
...
and field rewrite helpers. Install only when ``helpdesk_mgmt`` is part
of the stack.
...
`feedback <https://github.com/Escodoo/ai-addons/issues/new?body=module:%20ai_agno_thread_bridge_helpdesk_mgmt%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `Escodoo/ai-addons <https://github.com/Escodoo/ai-addons/tree/18.0/ai_agno_thread_bridge_helpdesk_mgmt>`_ project on GitHub.
