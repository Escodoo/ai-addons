...
.. |badge3| image:: https://img.shields.io/badge/github-Escodoo%2Fai--addons-lightgray.png?logo=github
    :target: https://github.com/Escodoo/ai-addons/tree/18.0/ai_agno_chatter_bots
...
business channel (``erp``, ``ops``, ``support``, ``sales``,
``marketing``, ``web``). Each user has ``ai_bridge_id`` pointing at its
bridge so Discuss routes messages to ``/bridge/chatter/<agent_key>`` on
the Agno service.
...
``ai_agno_chatter_bots.bridge_auth_token`` (wins over ``odoo.conf``).
...
`feedback <https://github.com/Escodoo/ai-addons/issues/new?body=module:%20ai_agno_chatter_bots%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `Escodoo/ai-addons <https://github.com/Escodoo/ai-addons/tree/18.0/ai_agno_chatter_bots>`_ project on GitHub.
