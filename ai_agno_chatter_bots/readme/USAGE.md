Start a direct message with any bot user (e.g. Bot Suporte), or add the bot to
a Discuss channel. In channels with more than two members the bot only replies
when mentioned.
